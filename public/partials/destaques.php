...
<article class="product-card">
  ...
  <a href="product.php?id=17" class="product-image">
    <img src="assets/img/GERAL/2.png" alt="Monitor AOC X06">
  </a>

  <h3 class="product-title">
    <a href="product.php?id=17">Monitor AOC X06</a>
  </h3>
  ...
  <a
    class="btn-black"
    href="cart-add.php?name=<?= urlencode('Monitor AOC X06') ?>
